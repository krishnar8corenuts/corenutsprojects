...
//@CrossOrigin(origins = "http://34.138.180.59:4200", allowedHeaders = {"Authorization", "Origin"})
@RestController
...
public class WeekendController {
	...
	public ResponseEntity<String> changeStatusOfCity(@PathVariable(value = "cityId") Long cityId) {
		...
		String url = "http://34.138.180.59:8082/tour/weekendtrip/city/changestatusofcity/" + cityId;
	...
	public ResponseEntity<String> generatePdfForUser(@PathVariable(value = "travellerId") long travellerId) {
		...
		String url = "http://34.138.180.59:8082/tour/weekendtrip/traveller/pdf/user/" + travellerId;
	...
	public ResponseEntity<String> paymentStatus(@PathVariable int amount, @PathVariable int id) {
		...
		String url = "http://34.138.180.59:8082/tour/weekendtrip/traveller/payment/" + amount + "/" + id;
