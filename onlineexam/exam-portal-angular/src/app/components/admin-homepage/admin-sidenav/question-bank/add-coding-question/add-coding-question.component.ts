...
export class AddCodingQuestionComponent {
  ...
  onSubmit(id?:number): void {
    ...
    this.http.post(`http://34.138.180.59:8089/api/addcodingquestion/${id}`, this.codingQuestion).subscribe(
  ...
  getallcodingquestions(id?:number){
    this.http.get(`http://34.138.180.59:8089/api/getallcodingquestions/${id}`).subscribe((data)=>{
      console.log(data)
...
console.log(this.inputs)
    this.inputs.forEach((data)=>{
      ...
      this.http.post(`http://34.138.180.59:8089/api/addtestcases/${this.codingQuestionId}`,this.testCases).subscribe((data)=>console.log(data))
    ...
    // this.http.post(`http://34.138.180.59:8089/api/addtestcases/${this.codingQuestionId}`,this.testCasesArray).subscribe((data)=>console.log(data))
