...
this.route.paramMap.subscribe(params=>{
  ...
  this.http.get(`http://34.138.180.59:8088/api/getUserById/${id2}`).subscribe(data=>{
    console.log(data);
    this.user2=data;
  ...
  updateprofile()
{
  this.user3.id=this.id;
    this.http.post(`http://34.138.180.59:8088/api/updateUser`,this.user3).subscribe(data=>{console.log(data)
    this.ngOnInit();
  })
}
}
